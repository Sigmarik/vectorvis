...
enum PrimitiveType {
    ...
    /**
     * @brief Draw set of unconnected lines (f.e. [0]---[1]   [2]---[3]
     * [4]---[5]
     * ...)
     *
     */
    ...
    /**
     * @brief Draw a set of connected triangles where each triangle shares its
     * two last vertices with the next one (<0 1 2> <1 2 3> <2 3 4> <3 4 5> ...)
     *
     */
    TriangleStrip,
