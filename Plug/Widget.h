...
class Widget {
   ...
   protected:
     ...
     *
     * @param stack
     * @param position position to check (in stack output coords (screen coords
     * in most cases))
    ...
    virtual void onMouseReleased(
        [[maybe_unused]] const MouseReleasedEvent &event,
        [[maybe_unused]] EHC &context) {}
    ...
    virtual void onKeyboardPressed(
        [[maybe_unused]] const KeyboardPressedEvent &event,
        [[maybe_unused]] EHC &context) {}
     ...
     * @param ehc event handling context
     */
    virtual void onKeyboardReleased(
        [[maybe_unused]] const KeyboardReleasedEvent &event,
        [[maybe_unused]] EHC &context) {}
};
